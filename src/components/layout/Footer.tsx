...
const socialLinks = [
    {
        href: "https://linkedin.com/company/rewenue",
        label: "LinkedIn",
        icon: (
    ...
    {
        href: "https://twitter.com/rewenue",
        label: "Twitter",
        icon: (
            <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
    ...
    {
        href: "https://instagram.com/rewenue",
        label: "Instagram",
        icon: (
            <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
                ...
                <div className={styles.grid}>
                    ...
                    <div className={styles.brandColumn}>
                        ...
                        <p className={styles.brandDescription}>
                            ...
                            high-spending cardholders. Zero fees. Zero commission.
                        </p>
